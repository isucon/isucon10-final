...
pub enum Error {
    ...
    WebPushError(crate::notifier::WebPushNotifierError),
}
...
impl From<crate::notifier::WebPushNotifierError> for Error {
    fn from(e: crate::notifier::WebPushNotifierError) -> Self {
        Self::WebPushError(e)
    }
}
