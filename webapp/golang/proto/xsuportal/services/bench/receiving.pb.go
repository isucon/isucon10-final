...
var file_xsuportal_services_bench_receiving_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x6b, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x4d,
...
// UnimplementedBenchmarkQueueServer can be embedded to have forward compatible implementations.
...
func RegisterBenchmarkQueueServer(s *grpc.Server, srv BenchmarkQueueServer) {
	s.RegisterService(&_BenchmarkQueue_serviceDesc, srv)
}
...
var _BenchmarkQueue_serviceDesc = grpc.ServiceDesc{
