...
export class RegistrationForm extends React.Component<Props, State> {
  ...
  public renderTeamFormFields() {
    if (this.props.registrationSession.team && (this.props.registrationSession.team.leaderId != this.props.session.contestant?.id)) {
      ...
      return <>
        <div className="field">
          ...
          {this.isEditing() ? 
              <p className="help">代表者 {leader.name} のチームへ参加しています。チーム名・代表者メールアドレスは代表者のみが変更可能です。</p>
